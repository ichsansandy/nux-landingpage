...
export default function HeroSection() {
  return (
    <section id="hero ">
      <div className="py-14 px-7 lg:px-14 bg-background">
        <div className="inline tracking-tight text-[30px] leading-[35px] sm:text-[60px] md:text-[70px] md:leading-[60px] lg:text-display uppercase font-extrabold max-w-[1375px] lg:leading-[125px]">
